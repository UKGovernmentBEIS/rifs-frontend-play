...
case class TextField(label: Option[String], name: String, rules: Seq[FieldRule] = Seq(), value: Option[String] = None, errs: Option[NonEmptyList[String]] = None, question: Option[String] = None) extends Field {
